...
class Helper extends Review
{
   ...
   protected $productModel;
    ...
    public function getFofFeaturedProducts($slug)
    {
        ...
        switch ($slug) {
            ...
            case 'featured-products':
                ...
                if ($slug == "new-products") {
                    $products = $this->productRepository->getNewProducts($count);
                } else if ($slug == "featured-products") {
                    $products = $this->productRepository->getFeaturedProducts($count);
                }
    ...
    public function fofCategoriesProducts($slug)
    {
