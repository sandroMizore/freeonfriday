        ...
        <form method="post" action="{{ route('customer.address.create') }}" @submit.prevent="onSubmit">
            ...
            <div class="account-table-content">
                ...
                <div class="control-group" :class="[errors.has('phone') ? 'has-error' : '']">
                    ...
                    <input type="text" class="control fof-phone-control" name="phone" value="{{ old('phone') }}" v-validate="'required'" data-vv-as="&quot;{{ __('shop::app.customer.account.address.create.phone') }}&quot;">
