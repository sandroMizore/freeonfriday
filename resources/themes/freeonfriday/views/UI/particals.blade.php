<script type="text/x-template" id="cart-btn-template" ref="headerCart">
    <button
        type="button"
        id="mini-cart"
...
<script type="text/x-template" id="logo-template">
    <a
        :class="`fof-top-logo left ${addClass}`"
...
<script type="text/x-template" id="searchbar-template">
    <div class="row no-margin right searchbar">
        ...
        <div class="fof-searchbar-trigger" @click="fofShowSearchbar"><i class="fs16 fw6 rango-search"></i></div>


        <div class="fof-minicart">
    ...
    (() => {
        Vue.component('cart-btn', {
            ...
            created: function () {
              ...
              let carty = url.searchParams.get("showcart");


              if(carty == 'true') {
                this.toggleMiniCartSimple();
                console.log('go');
              }
            },
            methods: {
