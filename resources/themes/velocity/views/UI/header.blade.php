<script type="text/x-template" id="content-header-template">
    <header class="row velocity-divide-page vc-header header-shadow active">
        ...
        <div class="content-list fof-menues">
            <ul type="none" class="no-margin fof-menues-contaiener">
                <li class="fof-subcatmenu">
                  <a href="/shop" class="fof-subcatmenu-trigger">Каталог</a>
                  <div class="fof-subcatmenu-content" v-if="$root.sharedRootCategories.length > 0">
                      <li v-for="(category, index) in $root.sharedRootCategories">
                          <a class="unset" :href="`${$root.baseUrl}/${category.slug}`">
                              <div class="category-logo">
                                  <img
