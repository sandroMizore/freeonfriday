                    ...
                    <product-view>
                        <div class="form-container">
                            ...
                            <div class="right col-lg-6">
                                ...
                                <div class="row info">
                                    <h2 class="col-lg-12"><span class="fof-product-typy">{{ $product->typy }}</span> <span class="fof-product-name">{{ $product->name }}</span></h2>
                                ...
                                <div class="fof-product-shares-container">
                                  ...
                                  @include ('shop::products.wishlist', ['product' => $product])
                                </div>
